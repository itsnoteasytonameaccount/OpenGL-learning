...
OBJS := $(wildcard c/libs/src/*.cpp)
OBJS2 := $(wildcard c/object/*.cpp)
...
dist/libmyopengl.dll: $(OBJS)
	$(MAKE) $(SILENT_OPTION) -f c/libs/makefile

dist/libmyobject.dll: dist/libmyopengl.dll $(OBJS2)
	$(MAKE) $(SILENT_OPTION) -f c/object/makefile
...
$(COMPILE_PATH): $(DYNAMIC_LIBRARY)
	$(MAKE) $(SILENT_OPTION) -f c/$@/makefile CURRENT_PATH=$@
