...
INCLUDE_PATH = -I $(CUSTOM_LIBS_PATH)/include -I $(CUSTOM_LIBS_PATH)/imgui -I  $(CUSTOM_LIBS_PATH)/imgui/backends -I $(BASE_DIR)/libs/include -I $(BASE_DIR)/object
...
SRC_PATH := $(ROOT_PATH)\$(BASE_DIR)\$(CURRENT_PATH)
